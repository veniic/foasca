...
export default function RoundTable({ state }: Props) {
  ...
  return (
    <div className="relative mx-auto aspect-[10/9] w-full max-w-md">
      ...
      {/* Statusul central, când nu sunt cărți pe masă (sub cozul central) */}
      {state.currentTrick.length === 0 && (
        <div className="absolute left-1/2 top-[78%] z-10 w-40 -translate-x-1/2 -translate-y-1/2 text-center">
